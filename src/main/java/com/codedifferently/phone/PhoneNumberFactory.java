...
public final class PhoneNumberFactory {
    ...
    {   
        ...
        int centralOfficeCode = RandomNumberFactory.createInteger(100, 100);
    ...
    {   
        ...
        {   
            logger.info(phoneNumber + "not valid");
            return null;
        }
    }
    ...
    {   try
        ...
        {   
            System.out.println("Invalid number passed:" + phoneNumberString);
            logger.info(phoneNumberString + "not valid");
            throw ipnfe;
        }
